...
cat /var/www/html/server/www/downloads1.ids |grep '2-2'|grep -v SUSE|grep -v PCL|grep -v Atomic|grep -v apk>> /var/www/html/server/www/downloads.ids
...
echo "<h1>Alpine/APK Based</h1>sudo apk add ./hardinfo2-FULLNAME --allow-untrusted<br><br>" >>/var/www/html/server/www/downloads.ids
cat /var/www/html/server/www/downloads1.ids |grep  apk>> /var/www/html/server/www/downloads.ids
