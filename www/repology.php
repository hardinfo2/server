...
if(1*$r[0]){ //refresh
    ...
    for($x=0;$x<$col;$x++){
        if(strcmp(substr($ps[$x+$col*0][1],0,strlen($curver)),$curver)) {if($ps[$x+$col*0][1][0]=="2") $c1="orange"; else {if(is_null($ps[$x+$col*0][1])) $c1="#555"; else $c1="red";}} else $c1="green";
        if(strcmp(substr($ps[$x+$col*1][1],0,strlen($curver)),$curver)) {if($ps[$x+$col*1][1][0]=="2") $c2="orange"; else {if(is_null($ps[$x+$col*1][1])) $c2="#555"; else $c2="red";}} else $c2="green";
